			...
			<div class="collapse navbar-collapse justify-content-end"
				...
				<ul class="navbar-nav ">
					<li class="nav-item"><a class="nav-link smoth-scroll"
						href="addcategoryform.jsp">Add Category</a></li>
					<li class="nav-item"><a class="nav-link smoth-scroll"
						href="deletecategoryform.jsp">Delete Category</a></li>
					<li class="nav-item"><a class="nav-link smoth-scroll"
						href="vieworders.jsp">View Unconfirmed Orders</a></li>
					<li class="nav-item"><a class="nav-link smoth-scroll"
						href="additemtoproduct.jsp">Add Products</a></li>
					<li class="nav-item"><a class="nav-link smoth-scroll"
						href="viewallproductsadmin.jsp">View Available Products</a></li>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-12 text-center">
					<div class="footer-copy">2021 © All Rights Reserved.</div>
				</div>
			</div>
		</div>
	</section>
