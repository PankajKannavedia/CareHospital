	...
	<nav class="navbar navbar-default">
		<div class="container-fluid" id="nav">
			<div class="navbar-header">
				<a href="adminhome.jsp" class="navbar-brand" id="nav"> ADMIN
					HOME </a>
			</div>
			<ul class="nav navbar-nav navbar-right">
				<li><a href="logoutadmin.jsp" id="nav"><span
						class="glyphicon glyphicon-log-out" id="nav"></span> Logout</a></li>
			</ul>
		</div>
	</nav>
	<div class="container">
						...
						<td>
							<form action="DeleteProduct.jsp" method="post">
								<input type="hidden" name="productid"
									value="<%=p.getProductid()%>" /> <input class="btn btn-danger"
									id="myBtn2" type="submit" value="Delete This Product" />
							</form>
						</td>

						<td>
							<button id="myBtn" class="btn btn-danger"
								onclick="openMyDialog(<%=p.getProductid()%>)">Update
								This Product</button>
						</td>
		...
		<div id="myModal" class="modal">
			...
			<div class="modal-content">
				...
				<table class="table table-hover">
					<tr>
						<th align="center"><b>Enter Product Details To Be Updated
								: </b></th>
					</tr>
					<tr>
						<td><label class="control-label" for="pname">Enter
								New Name</label> <input type="text" class="form-control" id="pname"
							name="pname" /></td>
					</tr>
					<tr>
						<td><label class="control-label" for="price">Enter
					...
					<tr>
						<td><label class="control-label" for="pdesc">Enter
								New Description</label> <input type="text" class="form-control"
							id="pdesc" name="pdesc" /></td>
					</tr>
					<tr>
						<td><button id="btnUpdate" class="btn btn-danger"
								onclick="updateProduct()">Update Product</button></td>
					</tr>
				</table>
			</div>
		</div>
