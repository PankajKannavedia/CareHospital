...
<body>
	...
	<div id="topbar" class="d-flex align-items-center fixed-top">
		<div class="container d-flex justify-content-between">
			<div class="contact-info d-flex align-items-center">
				...
				<i class="bi bi-phone"></i> +91 7566402407
			</div>
	...
	<header id="header" class="fixed-top">
		<div class="container d-flex align-items-center">
			...
			<h1 class="logo me-auto" id="uname">
				<a href="#appointment">USER HOME</a>
			</h1>
			...
			<nav id="navbar" class="navbar order-last order-lg-0">
				<ul>
					...
					<li class="dropdown"><a href="#"><span>Products</span> <i
							class="bi bi-chevron-down"></i></a>
						<ul>
							<li><a href="displayproductpagination.jsp?page=1">Display
									Products</a></li>
			...
			<a href="#appointment" class="appointment-btn scrollto"><span
				class="d-none d-md-inline">Make an</span> Appointment</a><br> <br>
			<br>
	...
	<center>
		<section>
			...
			<a href="https://drive.google.com/file/d/1gLfnn_vExM3-rkjMrJMWFbFu4onxRfD8/view?usp=sharing" class="appointment-btn scrollto"><div
					class="d-none d-md-inline">Patient-Report</div> </a><br>
	...
	<section id="hero" class="d-flex align-items-center">
		<div class="container">
			...
			<h2>We are team of talented Doctors creating a new future</h2>
