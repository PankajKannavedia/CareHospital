...
<%@page import="com.hospital.daoimpl.AdminDAOImpl"%>
<%@page import="com.hospital.dao.AdminDAO"%>
...
%>
		<jsp:useBean id="admin" class="com.hospital.model.Admin">
...
%>
		<p style="color:red">admin-id or password didn't match !!!</p>
