	...
	<nav class="navbar " id="new">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				<li class="active"><a href="displayallproduct.jsp" id="head">All
						Products</a></li>
		...
		<div class="table-wrapper">
			...
			<div class="col-lg-4">
				<div class="panel panel-primary">
					...
					<div class="panel-body"><%=qs.getProductname()%><img
							src="Homepage/css/display.jpg" class="img-responsive"
							style="height: 195px; width: 100%" alt="Image">
					</div>
					<div class="panel-footer">
						Price :
						<%=qs.getPrice()%><br>Quantity Available
						<%=qs.getQuantity()%></div>

					<input type="hidden" name="productid"
						value="<%=qs.getProductid()%>" /> <input type="hidden"
						name="priceprod" value="<%=qs.getPrice()%>"> <input
						type="hidden" name="availquantity" value="<%=qs.getQuantity()%>">
					<input type="hidden" name="productid"
						value="<%=qs.getProductid()%>">
					<button id="myBtn" class="btn btn-danger"
						onclick="openMyDialog(<%=qs.getProductid()%>)">Place
						Order</button>
				</div>
			</div>
